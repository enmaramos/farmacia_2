...
<head>
  ...
  <meta charset="UTF-8">
  <title>Farmacia San francisco Javier</title><!--begin::Primary Meta Tags-->
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="title" content="Farmacia | Dashboard">
  ...
  <!-- Asegúrate de que esta línea esté en el <head> de tu documento -->
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.3/dist/sweetalert2.min.css">

  <!-- Agregar Bootstrap y jQuery en el head  MODAL-->
