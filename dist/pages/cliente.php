                    ...
                    <form action="../pages/Ctrl/agregar_cliente.php" method="POST">
                        <div class="modal-body">
                            ...
                            <label for="generoCliente" class="form-label">Genero</label>
                                <select class="form-control" name="generoCliente" id="generoCliente" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="direccionCliente" placeholder="Ingrese direccion" id="direccionCliente" required>
                            </div>
